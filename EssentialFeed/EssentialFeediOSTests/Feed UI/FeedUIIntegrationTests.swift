...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [image0, image1])
        XCTAssertEqual(loader.canceledImageURLs, [], "Expected no canceled image URL requests until image is not visible")
        ...
        XCTAssertEqual(loader.canceledImageURLs, [image0.url, image1.url], "Expected two canceled image URL requests once second image also is not visible anymore")
    }
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url], "Expected third image URL request after first retry action")

        view1?.simulateRetryAction()
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url, image0.url, image1.url], "Expected forth image URL request after second retry action")
    }
    ...
    func test_feedImageView_preloadsImageURLWhenNearVisible() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [image0, image1])
        XCTAssertEqual(loader.loadedImageURLs, [], "Expected no image URL requests until image is visible")
    ...
    func test_feedImageView_cancelsImageURLPreloadingWhenNotNearVisibleAnymore() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [image0, image1])
        XCTAssertEqual(loader.canceledImageURLs, [], "Expected no canceled image URL requests until image is not near visible")
